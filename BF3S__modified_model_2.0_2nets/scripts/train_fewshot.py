...
def get_arguments():
    ...
    config["exp_dir"] = exp_directory  # where logs, modelxs, etc will be stored.
...
def main():
    ...
    # print("config", config['auxiliary_rotation_task_coef'])
    ...
    # print("train_dataset_class", train_dataset_class)
    ...
    # print("dataset_train",dloader_train.nKnovel, dloader_train.nKbase, dloader_train.n_exemplars, dloader_train.n_test_novel, dloader_train.n_test_base, dloader_train.batch_size,  dloader_train.epoch_size)
    # print("dataser_test", dloader_val.nKnovel, dloader_val.nKbase, dloader_val.n_exemplars, dloader_val.n_test_novel, dloader_val.n_test_base, dloader_val.batch_size, dloader_val.epoch_size)
