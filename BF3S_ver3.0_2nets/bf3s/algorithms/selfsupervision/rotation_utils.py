...
def fewshot_classification_with_rotation_selfsupervision_1(
    features_train_rot,
    features_test_rot,
    feature_extractor,
    feature_extractor_optimizer,
    ...
    features_train_rot = features_train_rot.detach()
    features_test_rot = features_test_rot.detach()
    ...
    with torch.set_grad_enabled(is_train):
        ...
        (
            ...
            features_test_1 = features_test,
            features_train_1 = features_train,
            features_train_2 = features_train_rot,
            features_test_2 = features_test_rot,
    ...
    with torch.no_grad():
        ...
        # print("classification score", classification_scores)
        # record["AccuracyRot"] = utils.top1accuracy(scores_rotation, labels_rotation)
    
    if is_train:
        # loss_total.backward()
        loss_classsification.backward()
...
def fewshot_classification_with_rotation_selfsupervision_2(
    feature_extractor,
    feature_extractor_optimizer,
    # classifier,
    # classifier_optimizer,
    ...
    return record, features_train, features_test
    # return record, features_train_rot, features_test_rot
