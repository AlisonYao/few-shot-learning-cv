...
def object_classification_with_rotation_selfsupervision(
    ...
    # print("label size 0", labels.size(0)) 256
    # print("label rotation size 0", labels_rotation.size(0)) 256
    # print("base id", base_ids)
    record = {}
    with torch.set_grad_enabled(is_train):
        ...
        scores_classification, loss_classsification = cls_utils.classification_task(
            ...
            # classifier, features_cls, labels
        )
...
def fewshot_classification_with_rotation_selfsupervision(
    ...
    with torch.set_grad_enabled(is_train):
        ...
        features_test_1 = features_1[batch_size_train:batch_size_train_test]
        ...
        features_test_2 = features_2[batch_size_train:batch_size_train_test]
        ...
        scores_rotation, loss_rotation = rotation_task(
            classifier_rot, features_2, labels_rotation
        )
        record["loss_rot"] = loss_rotation.item()
